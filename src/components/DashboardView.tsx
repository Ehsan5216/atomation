  ...
  return (
    <div className="space-y-6">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div>
            <div className="flex items-center gap-2 text-amber-400 text-xs font-bold mb-1">
              ...
              <span>مدیریت اتوماسیون و ارتباطات - واحد اعلام حریق ذوب‌آهن اصفهان</span>
            </div>
            <h2 className="text-xl sm:text-2xl font-black text-white">
              سامانه اتوماسیون اداری و عملیاتی واحد اعلام حریق
            </h2>
            <p className="text-xs sm:text-sm text-slate-400 mt-1">
              گردش‌کار درخواست‌های شیفت، ثبت مانور و گراف‌ها، مکاتبات کارتابل و مدیریت انبارداری تخصصی
            </p>
          </div>
          ...
          <div className="flex flex-wrap items-center gap-2">
            <button
              ...
              className="flex items-center gap-2 px-3 py-2 rounded-xl bg-amber-500 hover:bg-amber-400 text-slate-950 text-xs font-bold transition shadow-lg shadow-amber-500/20 cursor-pointer"
            >
              <CalendarClock className="w-4 h-4" />
              <span>درخواست شیفت</span>
            </button>
            <button
              onClick={() => onNavigate('graphs')}
              className="flex items-center gap-2 px-3 py-2 rounded-xl bg-orange-600 hover:bg-orange-500 text-white text-xs font-bold transition shadow-lg shadow-orange-900/30 cursor-pointer"
            >
              <Activity className="w-4 h-4" />
              <span>ثبت مانور و گراف</span>
            </button>
            <button
              onClick={() => onNavigate('messages')}
              className="flex items-center gap-2 px-3 py-2 rounded-xl bg-blue-600 hover:bg-blue-500 text-white text-xs font-bold transition shadow-lg shadow-blue-900/30 cursor-pointer"
            >
              <Mail className="w-4 h-4" />
              <span>کارتابل پیام‌ها</span>
            </button>
          </div>
        </div>
        ...
        <div className="mt-5 relative">
          <div className="relative">
            ...
            <input
              ...
              placeholder="جستجوی سریع در انبار کالا (نام دتکتور، کد قطعه، برند یا مدل)..."
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div
          onClick={() => onNavigate('requests')}
          className="bg-slate-900 border border-slate-800 hover:border-amber-500/50 rounded-2xl p-5 cursor-pointer transition shadow-lg group"
        >
          <div className="flex items-center justify-between">
            ...
            <span className="text-[11px] text-amber-400 font-bold group-hover:underline">ورود به بخش &larr;</span>
          </div>
          <h3 className="text-sm font-bold text-white mt-3">درخواست جا‌به‌جایی شیفت</h3>
          <p className="text-xs text-slate-400 mt-1 leading-relaxed">
            گردش‌کار رسمی تغییر شیفت با تایید دو مرحله‌ای سرپرست شیفت (فورمن) و مهندس شیفت به همراه تایم‌لاین بصری.
          </p>
        </div>

        <div
          onClick={() => onNavigate('graphs')}
          className="bg-slate-900 border border-slate-800 hover:border-orange-500/50 rounded-2xl p-5 cursor-pointer transition shadow-lg group"
        >
          <div className="flex items-center justify-between">
            ...
            <span className="text-[11px] text-orange-400 font-bold group-hover:underline">ورود به بخش &larr;</span>
          </div>
          <h3 className="text-sm font-bold text-white mt-3">ثبت مانور و گراف اعلام حریق</h3>
          <p className="text-xs text-slate-400 mt-1 leading-relaxed">
            ثبت تعداد ادوات بررسی‌شده (دتکتور دودی، حرارتی، شستی، پنل، ماژول و آژیر) با انتخاب پرسنل و خروجی اکسل.
          </p>
        </div>

        <div
          onClick={() => onNavigate('messages')}
          className="bg-slate-900 border border-slate-800 hover:border-blue-500/50 rounded-2xl p-5 cursor-pointer transition shadow-lg group"
        >
          <div className="flex items-center justify-between">
            ...
            <span className="text-[11px] text-blue-400 font-bold group-hover:underline">ورود به بخش &larr;</span>
          </div>
          <h3 className="text-sm font-bold text-white mt-3">کارتابل و مکاتبات اداری</h3>
          <p className="text-xs text-slate-400 mt-1 leading-relaxed">
            ارسال پیام و دستورالعمل اداری به همراه پیوست فایل تا ۱۰۰ مگابایت، با وضعیت خوانده شده و عدم امکان ویرایش.
          </p>
        </div>
      </div>

      {/* Metrics Row (Warehouse & Storage) */}
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        >
          <div className="flex items-center justify-between">
            <span className="text-xs font-medium text-slate-400">قفسه‌ها و مکان‌ها</span>
          ...
          <div className="mt-3 flex items-baseline gap-2">
            ...
            <span className="text-xs text-slate-400">لوکیشن قفسه</span>
          </div>
        </div>
